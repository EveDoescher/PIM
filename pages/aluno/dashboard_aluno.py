...
class DashboardAluno(ft.Container):
    """Classe responsável pelo dashboard do aluno."""

    def __init__(self, page: ft.Page, controller):
        """Inicializa o dashboard do aluno."""
        super().__init__()
        self.page = page
        self.controller = controller

        # Título de boas-vindas
        username = self.controller.current_user['username'] if self.controller.current_user else "Aluno"
        ...
        self.view_task_card = ft.Card(
            content=ft.Container(
                content=ft.Column([
                    ft.Container(
                        content=ft.Icon(ft.Icons.ASSIGNMENT, size=64, color=ft.Colors.TEAL_600),
                    ...
                    ft.ElevatedButton(
                        ...
                        color=ft.Colors.WHITE,
                        on_click=self.go_to_ver_tarefas,
                        style=ft.ButtonStyle(
                            shape=ft.RoundedRectangleBorder(radius=20),
                            elevation=3
                        )
        ...
        # Card para ver notas
        self.view_grades_card = ft.Card(
            content=ft.Container(
                content=ft.Column([
                    ft.Container(
                        content=ft.Icon(ft.Icons.GRADE, size=64, color=ft.Colors.PURPLE_600),
                        padding=ft.padding.only(bottom=15)
                    ),
                    ft.Text(
                        "Ver Notas", 
                ...
                gradient=ft.LinearGradient(
                    ...
                    colors=[ft.Colors.WHITE, ft.Colors.PURPLE_50]
                )
            ),
            elevation=6
        )
    ...
    def go_to_ver_notas(self, e):
        """Navega para a tela de ver notas."""
