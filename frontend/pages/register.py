...
class Register(ft.Container):
    ...
    def __init__(self, page: ft.Page, controller):
        # Inicializa a interface de registro com configurações básicas
        super().__init__(
            expand=True,
            width=None,
            height=None,
    ...
    def create_components(self):
        # Cria todos os componentes visuais da tela de registro
    ...
    def create_role_button(self, value, label, icon):
        # Cria botões de seleção de tipo de usuário
            ...
            content=ft.Column([
                ft.Container(
                    ...
                    shadow=ft.BoxShadow(
                        spread_radius=0,
                        blur_radius=55,
                        color=ft.colors.with_opacity(0.22, ft.colors.PURPLE_400),
    ...
    def select_role(self, role):
        # Seleciona o tipo de usuário e atualiza a interface
        ...
        self.professor_button.style.elevation = 6 if role == "professor" else 2
        ...
        self.aluno_button.style.elevation = 6 if role == "aluno" else 2
